class MainScene3 extends Phaser.Scene {
    ...
    create() {
        ...
        //loading up the owlet sprite

        //adding the sprite and then setting the scale on the screen
        //load up the white sprite
        this.pet = this.add.sprite(200, 500, "pet2run")
        this.pet.setScale(6);
        ...
        this.gameTimer = this.time.addEvent({
            ...
            callback: function () {
                ...
                clothing.on('pointerdown', () => this.pet.anims.stop('runpet'));
                clothing.on('pointerdown', () => this.pet.anims.play('feedingpet'));
                clothing.on('pointerup', () => this.pet.anims.stop('feedingpet'));
                clothing.on('pointerup', () => this.pet.anims.play('runpet'));
                ...
                bath.on('pointerdown', () => this.pet.anims.stop('runpet'));
                bath.on('pointerdown', () => this.pet.anims.play('petbathing'));
                bath.on('pointerup', () => this.pet.anims.stop('petbathing'));
                bath.on('pointerup', () => this.pet.anims.play('runpet'));
                ...
                playing.on('pointerdown', () => this.pet.anims.stop('runpet'));
                playing.on('pointerdown', () => this.pet.anims.play('healthplus'));
                playing.on('pointerup', () => this.pet.anims.stop('healthplus'));
                playing.on('pointerup', () => this.pet.anims.play('runpet'));
                ...
                feeding.on('pointerdown', () => this.pet.anims.stop('runpet'));
                feeding.on('pointerdown', () => this.pet.anims.play('feedingpet'));
                //feeding.on('pointerup',() =>this.signal=0);
                feeding.on('pointerup', () => this.pet.anims.stop('feedingpet'));
                feeding.on('pointerup', () => this.pet.anims.play('runpet'));
