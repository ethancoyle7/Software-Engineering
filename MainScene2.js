class MainScene2 extends Phaser.Scene {
    ...
    preload() {
        ...
        //load up the sprite sheet for the blue monster
    ...
    create() {
        ...
        //load up the sprite for blue
        //adding the sprite and then setting the scale on the screen
        this.pet = this.add.sprite(200, 500, "pet3")
        this.pet.setScale(6);
        //creating pet animation

        //adding some anim effects for the second pet
        ...
        //anim for interactions with the playing
        this.pet.anims.create({
            key: 'plushealth',
        ...
        //anim for the bathing animation
        this.pet.anims.create({
            key: 'bathing',
        ...
        //on load up of the scene play the animation for scene
        this.pet.anims.play('pet3run');
        ...
        this.gameTimer = this.time.addEvent({
            ...
            callback: function () {
                ...
                clothing.on('pointerdown', () => this.pet.anims.stop('pt3run'));
                clothing.on('pointerdown', () => this.pet.anims.play('feed'));
                clothing.on('pointerup', () => this.pet.anims.stop('feed'));
                clothing.on('pointerup', () => this.pet.anims.play('pet3run'));
                ...
                bath.on('pointerdown', () => this.pet.anims.stop('pet3run'));
                bath.on('pointerdown', () => this.pet.anims.play('bathing'));
                bath.on('pointerup', () => this.pet.anims.stop('bathing'));
                bath.on('pointerup', () => this.pet.anims.play('pet3run'));
                ...
                playing.on('pointerdown', () => this.pet.anims.stop('pet3run'));
                playing.on('pointerdown', () => this.pet.anims.play('plushealth'));
                playing.on('pointerup', () => this.pet.anims.stop('plushealth'));
                playing.on('pointerup', () => this.pet.anims.play('pet3run'));
                ...
                feeding.on('pointerdown', () => this.pet.anims.stop('pet3run'));
                ...
                feeding.on('pointerup', () => this.pet.anims.play('pet3run'));
